import { QUESTIONCONFIGLIST, INPUTCONFIGLIST } from "./ActionCreator";
...
export default (state = initialState, action: any) => {
  switch (action.type) {
    ...
    case QUESTIONCONFIGLIST: {
      return state.question_config_list;
    }

    case INPUTCONFIGLIST:  {
      return state.input_config_list;
    }
